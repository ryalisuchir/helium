    ...
    if (
      ...
      return interaction.reply({
        embeds: [
          new EmbedBuilder()
            .setDescription(
              `Only the owner of the server can run this command.`
            )
            .setColor("303136"),
        ],
        ephemeral: true,
...
`
            ...
            .setFooter({
              text: "Please only proceed if you agree with the previous statements made. You, and admins of the bot will not have access to revert this decision.",
            })
            .setColor("303136"),
        ],
        components: [
