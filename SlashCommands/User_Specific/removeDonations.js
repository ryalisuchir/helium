...
<:slash:980152110127669279> setpings <event> <role>`
			...
			if (parseInt(eventDonation.amount) > parseInt(dSchema.donations.event)) {
				return interaction.reply({
					embeds: [
						new EmbedBuilder()
						.setDescription(`You cannot remove more donations than ${eventDonation.user} has.
...
> This is specifically in the events category.`)
			...
			interaction.reply({
				embeds: [
					new EmbedBuilder()
						.setDescription(`Removed **⏣ ${eventDonation.amount}** from ${eventDonation.user}'s *event* donations.`)
						.setColor('303136')
				]
			})
...
<:slash:980152110127669279> setpings <giveaway> <role>`
			...
			if (parseInt(giveawayDonation.amount) > parseInt(dSchema.donations.giveaway)) {
				return interaction.reply({
					embeds: [
						new EmbedBuilder()
						.setDescription(`You cannot remove more donations than ${giveawayDonation.user} has.
...
> This is specifically in the giveaways category.`)
			...
			interaction.reply({
				embeds: [
					new EmbedBuilder()
						.setDescription(`Removed **⏣ ${giveawayDonation.amount}** from ${giveawayDonation.user}'s *giveaway* donations.`)
						.setColor('303136')
				]
			})
...
<:slash:980152110127669279> setpings <heist> <role>`
			...
			if (parseInt(heistDonation.amount) > parseInt(dSchema.donations.heist)) {
				return interaction.reply({
					embeds: [
						new EmbedBuilder()
						.setDescription(`You cannot remove more donations than ${heistDonation.user} has.
...
> This is specifically in the heists category.`)
			...
			interaction.reply({
				embeds: [
					new EmbedBuilder()
						.setDescription(`Removed **⏣ ${heistDonation.amount}** from ${heistDonation.user}'s *heist* donations.`)
						.setColor('303136')
				]
			})
